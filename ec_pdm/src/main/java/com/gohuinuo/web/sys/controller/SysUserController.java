...
public class SysUserController {
	...
	* @return
	...
	public @ResponseBody JSONObject validateNameByAjax(String param,Long id) throws IOException{
		...
		return sysUserService.getUserNameCountByName(param,id);
	}
	...
	* @return
	...
	public String showLayer(Long id,@PathVariable("mode") String mode, Model model){
		...
		}else if(mode.equals("myEdit")){
			return "sys/userCenter/user-save";
		}else{
	...
	* @return
	...
	public @ResponseBody List<SysUser> findUsers(String findTxt){
		return sysUserService.findUsers(findTxt);
	}
