...
public class GenXml extends JFrame {
	...
	public GenXml() {
		...
		label_4 = new JLabel("作者：");
		label_4.setBounds(106, 191, 99, 15);
		panel.add(label_4);

		author = new JTextField();
		author.setColumns(10);
		author.setBounds(215, 184, 312, 30);
		panel.add(author);
	...
	private ActionListener doneListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			dlExcel.setColumns(columns);
			dlExcel.setClazz(clasz);
			dlExcel.setAuthor(author.getText());
	...
	private void next0() {
		...
		if (!clasz.equals("")&&!xmlPath.equals("")) {
			...
			JOptionPane.showMessageDialog(GenXml.this, "请输入s路径!");
		}
	}
	...
	private void ReadInTable(String clasz) {
		...
		try {
			BeanInfo sourceBean = Introspector.getBeanInfo(Class.forName(clasz), java.lang.Object.class);  
