...
<div class="clearfix">
	...
	<div>
		...
		@			}
			<li>
				<select id="pageSizeNum" class="ui-pg-selbox" role="listbox" onchange="paging('${formId}',1)">
					<option value="10" role="option"
					@if(pageSize == 10) {
						selected
					@}
					>10</option>
					<option value="50" role="option"
						@if(pageSize == 50) {
							selected
						@}
					>50</option>
					<option value="200" role="option"
						@if(pageSize == 200) {
							selected
						@}
					>200</option>
					<option value="500" role="option"
						@if(pageSize == 500) {
							selected
						@}
					>500</option>
